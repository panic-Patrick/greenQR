      ...
      <div className="bg-gray-800 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4 text-gray-300">
          ...
          <section aria-labelledby="privacy-overview">
            <h3 id="privacy-overview" className="text-xl font-semibold mb-2">1. Datenschutz auf einen Blick</h3>
          ...
          <section aria-labelledby="privacy-hosting">
            <h3 id="privacy-hosting" className="text-xl font-semibold mb-2">2. Hosting</h3>
          ...
          <section aria-labelledby="privacy-local">
            <h3 id="privacy-local" className="text-xl font-semibold mb-2">3. Lokale Datenverarbeitung</h3>
          ...
          <section aria-labelledby="privacy-cookies">
            <h3 id="privacy-cookies" className="text-xl font-semibold mb-2">4. Cookies</h3>
